...
if(isset($_POST['add_staff'])){
    ...
    if(mysqli_num_rows($select_users) > 0){
        $message[] = 'user already exist!';
           ...
           mysqli_query($conn, "INSERT INTO `account`(FName, LName, TelephoneNum,Email,Address,Password,Birthday,ROLE_NO) VALUES('$FName','$LName','$TelephoneNum', '$Email','$Address', '$Password','$Birthday','$RoleID')") or die('query failed');
...
if(isset($_POST['update_staff'])){
    ...
    mysqli_query($conn, "UPDATE `account` SET FName='$update_FName', LName='$update_LName', TelephoneNum='$update_TelephoneNum', Address='$update_Address', Birthday='$update_Birthday', Email='$update_Email', Password='$update_Password', ROLE_NO='$update_Role' WHERE Account_ID='$update_p_id'"
    ) or die ('query failed here');
    }

    else {
      mysqli_query($conn, "UPDATE `account` SET FName='$update_FName', LName='$update_LName', TelephoneNum='$update_TelephoneNum', Address='$update_Address', Birthday='$update_Birthday', Email='$update_Email', ROLE_NO='$update_Role' WHERE Account_ID='$update_p_id'"
    ) or die ('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="date" name="Birthday" class="box" placeholder="birthday" required>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <!--birthday-->
      <input type="date" name="update_Birthday" value="<?php echo $fetch_update['Birthday']; ?>" class="box" required placeholder="enter birthday">
