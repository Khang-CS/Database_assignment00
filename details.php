...
if(isset($_POST['comment'])){
   ...
   $add_comment=mysqli_query($conn,"INSERT INTO `review` (ACCID,Product_ID,Content,Rating,Image) VALUES ('$ACCID','$Product_ID','$Content','$Rating','$image')") or die ('query failed');
...
<section class="about">
   ...
   <div class="flex">
      ...
      <div class="image" style="margin-bottom: 30px; background-color: var(--purple); border-radius: 30px;">
