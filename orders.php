...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <?php
         $order_query = mysqli_query($conn, "SELECT * FROM `orders` WHERE ACC_ID = '$user_id'") or die('query failed');
      ...
      <div class="box">
         ...
         <p> payment status : <span style="color:<?php if($fetch_orders['Status'] == 'Proccessing'){ echo 'yellow'; }
         elseif ($fetch_orders['Status']=='Cancelled') {echo 'red'; }
